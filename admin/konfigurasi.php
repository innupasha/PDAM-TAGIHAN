...
<div class="container">
    ...
    if(isset($_REQUEST['submit'])){
      ...
      $cfginstansi = $_REQUEST['cfginstansi'];
      $cfgTahun = $_REQUEST['cfgTahun'];
      $cfgTgl = $_REQUEST['cfgTanggal'].' '.$_REQUEST['cfgJam'];

      $qCfg = "UPDATE un_konfigurasi SET instansi='$cfginstansi',tahun='$cfgTahun',tgl_pengumuman='$cfgTgl' WHERE id='$cfgID'";
...
<form class="form-horizontal" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" name="cfginstansi" class="form-control" value="<?=$hsl['instansi'] ?>" readonly>
    </div>
  </div>
  <div class="form-group">
